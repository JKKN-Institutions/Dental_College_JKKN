      ...
      menus: [
        {
          ...
          submenus: [
            ...
            { href: '/academics/curriculum-feedback', label: 'Learning Framework Feedback', icon: ClipboardList, active: pathname === '/academics/curriculum-feedback' },
      ...
      menus: [
        {
          ...
          submenus: [
            { href: '/committee/student-council/view-document', label: 'Learner Council', icon: UsersRound, active: pathname.includes('/student-council') },
            ...
            { href: '/committee/student-welfare-committee', label: 'Learner Welfare Committee', icon: HeartHandshake, active: pathname.includes('/student-welfare') },
            ...
            { href: '/committee/international-student-cell-committee', label: 'International Learner Cell', icon: Globe, active: pathname.includes('/international-student') },
      ...
      menus: [
        {
          ...
          submenus: [
            ...
            { href: '/facilities/library', label: 'Learning Commons', icon: BookCopy, active: pathname === '/facilities/library' },
            { href: '/facilities/labs', label: 'Learning Labs', icon: FlaskRound, active: pathname === '/facilities/labs' },
            ...
            { href: '/facilities/digital-class-room', label: 'Digital Learning Studio', icon: Monitor, active: pathname === '/facilities/digital-class-room' },
