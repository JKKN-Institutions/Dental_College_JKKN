...
export default function ErodePage() {
  ...
  const whyFeatures = [
    ...
    { icon: '🚌', title: 'Easy Commute', desc: 'Just 30-40 km from Erode. Daily commute or comfortable hostel — your choice.' },
  ];
  ...
  const transportRows = [
    { icon: '🛣️', label: 'ROUTE', text: 'NH-544 — direct highway connectivity' },
    { icon: '🚌', label: 'BY BUS', text: 'Regular government and private buses from Erode Central Bus Stand to Komarapalayam available throughout the day' },
    { icon: '🚆', label: 'NEAREST RAILWAY STATION', text: 'Erode Junction (~35 km from campus)' },
    { icon: '✈️', label: 'NEAREST AIRPORT', text: 'Coimbatore International Airport (Code: CJB) (~80 km)' },
  ...
  const facilities = [
    ...
    { icon: '🚌', title: 'Transport', desc: 'College buses connecting to Erode and surrounding areas' },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 text-left shadow-sm">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic mb-6">
                [Student testimonial from Erode to be added here. Include their experience at JKKN Dental, what they liked about the campus, and their career outcomes.]
              </p>
              <div>
