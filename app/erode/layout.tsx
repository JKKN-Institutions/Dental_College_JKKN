...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "What is the BDS fee at dental colleges near Erode?", "acceptedAnswer": { "@type": "Answer", "text": "At JKKN Dental College and Hospital, the nearest major dental college to Erode, BDS tuition fees are approximately two lakh fifty thousand rupees per year under Government Quota. Contact nine three four five eight five five zero zero one for the latest 2026-27 fee structure." } },
