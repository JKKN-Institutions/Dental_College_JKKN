...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Is JKKN Dental College good for higher studies after BDS?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, JKKN Dental College has a strong track record of students clearing NEET MDS and pursuing postgraduate specialisations. The college offers MDS in 5 specialisations and provides dedicated coaching and mentoring for competitive exams." } },
    { "@type": "Question", "name": "Does JKKN have placement for MDS students?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, MDS graduates from JKKN receive dedicated placement support. With advanced clinical training across 5 specialisations and 50+ faculty publications, MDS graduates are placed in teaching institutions, specialty hospitals, and research organisations." } },
  ]
};
...
const howToSchema = {
  ...
  "step": [
    { "@type": "HowToStep", "position": 1, "name": "Registration & Profile Building", "text": "Students register with the CDC and build their professional profiles including academic records, clinical experience, and career preferences." },
    { "@type": "HowToStep", "position": 2, "name": "Resume Workshop & Skill Development", "text": "CDC conducts resume writing workshops, soft skills training, and professional development sessions to prepare students for the job market." },
    { "@type": "HowToStep", "position": 3, "name": "Company Connect & Campus Drives", "text": "CDC organises campus recruitment drives, industry interactions, and connects students with 25+ recruiting partners including corporate dental chains and hospitals." },
