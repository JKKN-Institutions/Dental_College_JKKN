    ...
    sections: [
      {
        children: [
          ...
          p('5. Strategic Location & Residential Campus \u2014 Situated on NH-544 (Salem-Coimbatore Highway) at Natarajapuram, Komarapalayam, easily accessible from Erode (~18 km), Salem (~60 km) and Namakkal town (~65 km). The residential campus includes hostel, library, and sports facilities.'),
          p(''),
