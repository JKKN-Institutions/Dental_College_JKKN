...
export default function TrichyPage() {
  ...
  const whyFeatures = [
    ...
    { icon: <Home className="w-6 h-6 text-[#006837]" />, title: 'Residential Campus', desc: 'Separate boys and girls hostels — comfortable stay for learners from Trichy' },
  ];
  ...
  const transportRows = [
    { icon: <Route className="w-6 h-6 text-[#006837]" />, label: 'ROUTE', text: 'NH-44 from Trichy to Namakkal (~90 km), then via Tiruchengode to Komarapalayam (~55 km) — approximately 145 km total' },
    { icon: <Bus className="w-6 h-6 text-[#006837]" />, label: 'BY BUS', text: 'Frequent government buses from Trichy Central Bus Stand towards Salem and Erode via Namakkal; get down at Komarapalayam or connect from Erode' },
    { icon: <Train className="w-6 h-6 text-[#006837]" />, label: 'BY TRAIN', text: 'Trains from Tiruchchirappalli Junction towards Erode Junction via Karur — Erode Junction is ~18 km from campus' },
    { icon: <Plane className="w-6 h-6 text-[#006837]" />, label: 'NEAREST AIRPORT', text: 'Coimbatore International Airport (Code: CJB) (~108 km from campus); Trichy International Airport (TRZ) serves the Trichy side' },
  ...
  const cities = [
    ...
    { icon: <Target className="w-6 h-6 text-[#006837]" />, name: 'Madurai', dist: '~215 km', href: '/madurai/' },
    { icon: <Sparkles className="w-6 h-6 text-[#006837]" />, name: 'Erode', dist: '~18 km', href: '/erode/' },
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li className="text-gray-900 font-medium">Dental College near Trichy</li>
          </ol>
        </div>
      </nav>
      ...
      >
        ...
        <h1 className="text-white font-extrabold leading-tight mb-3 max-w-4xl" style={{ fontSize: 'clamp(2rem, 5vw + 0.5rem, 3.5rem)' }}>
          Dental College near <span className="text-[#7cb983]">Trichy</span>
        </h1>
        ...
        <p className="text-white/80 max-w-2xl mb-10 leading-relaxed" style={{ fontSize: 'clamp(0.9rem, 1vw + 0.5rem, 1.1rem)' }}>
          ...
          NH-44 ride via Namakkal. BDS with 100 seats, MDS in 5 specialisations, and a 200+ chair teaching hospital with 93.9% placed or in higher studies (2024-25 batch).
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=trichy" target="_blank" rel="nofollow noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-full transition-all transform hover:scale-105 shadow-lg text-base">
            Apply Now — 2026-27
          </a>
      ...
      <div className="speakable-summary sr-only" id="speakable-intro">
        JKKN Dental College and Hospital is an established NDC-approved dental college accessible from Trichy, located approximately one hundred and forty-five kilometres away at Komarapalayam, Namakkal, via NH-44. The college offers BDS with one hundred seats and MDS with five specialisations, affiliated to TN Dr. MGR Medical University.
      </div>

      {/* ── Snippet Answer Section (AEO Target) ── */}
      <section className="bg-white py-12 px-4" id="dental-colleges-trichy">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-extrabold text-gray-900 mb-4" style={{ fontSize: 'clamp(1.4rem, 2.5vw + 0.5rem, 2rem)' }}>
            Are There Any Dental Colleges in Trichy?
          </h2>
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4" style={{ fontSize: 'clamp(0.9rem, 1vw + 0.4rem, 1.05rem)' }}>
            <li>Direct NH-44 connectivity — Trichy to Namakkal is a smooth ~90 km highway drive</li>
            <li>Namakkal district hosts established NDC-approved dental colleges with both BDS and MDS</li>
            <li>Full residential campus at JKKN — separate hostels, mess, and weekend travel home is easy</li>
          </ul>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center gap-6 justify-between">
            <div className="flex items-start gap-5">
              <div className="text-[#006837] font-extrabold leading-none" style={{ fontSize: 'clamp(3rem, 6vw, 4rem)' }}>
                145<span className="text-xl sm:text-2xl font-bold">km</span>
              </div>
              <div>
                <p className="font-bold text-gray-900 text-base sm:text-lg">From Trichy to JKKN Dental</p>
                <p className="text-gray-500 text-sm mt-1">3–3.5 hours via NH-44 through Namakkal</p>
              </div>
            </div>
            <a
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="font-extrabold text-gray-900 mb-4" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            Why Trichy Learners Choose JKKN Dental
          </h2>
      ...
      <section className="bg-[#FBFBEE] py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="font-extrabold text-gray-900 mb-3" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            BDS and MDS Programs at JKKN Dental College Near Trichy
          </h2>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-extrabold text-gray-900 mb-3 text-center" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            BDS Admission 2026 — How to Apply from Trichy
          </h2>
          <p className="text-gray-500 text-base mb-4 text-center">Step-by-step admission process for Trichy learners</p>
          ...
          <ol className="space-y-4 list-none p-0 m-0">
            {[
              ...
              { step: 'Step 5', title: 'Confirm Admission', desc: 'Pay the first year fee and confirm your seat. Hostel registration available separately for learners from Trichy.' },
            ].map((item) => (
          ...
          <div className="mt-8 text-center">
            <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=trichy" target="_blank" rel="nofollow noopener noreferrer" className="inline-block bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-full transition-all transform hover:scale-105 shadow-lg text-sm">
      ...
      <section className="bg-[#FBFBEE] py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-extrabold text-gray-900 mb-3" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            How Far Is JKKN Dental College from Trichy?
          </h2>
          <p className="snippet-answer text-gray-700 text-base mb-4">JKKN Dental College &amp; Hospital is approximately 145 km from Trichy via NH-44 through Namakkal, a journey of approximately 3 to 3.5 hours by road. Trains from Tiruchchirappalli Junction towards Erode Junction (via Karur) bring you within 18 km of the campus.</p>
          <div className="w-14 h-1 bg-[#7cb983] rounded mx-auto mb-10" />
          <div className="bg-white rounded-2xl overflow-hidden shadow-sm text-left">
            <div className="bg-[#006837] text-white px-6 py-5 flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-lg">Trichy → JKKN Dental Campus</p>
                <p className="text-white/80 text-sm">~145 km • 3–3.5 hours via NH-44</p>
              </div>
            </div>
      ...
      <section className="bg-white py-16 px-4" id="about-jkkn-trichy">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-extrabold text-gray-900 mb-3 text-center" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            JKKN Dental College &amp; Hospital — Key Facts
          </h2>
          <p className="text-gray-500 text-base mb-4 text-center">Essential information for Trichy learners considering dental education</p>
          <div className="w-14 h-1 bg-[#7cb983] rounded mx-auto mb-10" />
      ...
      <section className="bg-[#FBFBEE] py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-base mb-4">Common questions about dental education options for Trichy learners</p>
          <div className="w-14 h-1 bg-[#7cb983] rounded mx-auto mb-12" />
