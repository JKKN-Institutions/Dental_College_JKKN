...
export default function TiruppurPage() {
  ...
  const whyFeatures = [
    ...
    { icon: '🚌', title: 'Easy Commute', desc: 'Just 80-90 km from Tiruppur. Daily commute or comfortable hostel — your choice.' },
  ];
  ...
  const transportRows = [
    { icon: '🛣️', label: 'ROUTE', text: 'NH-544 via Erode, then State Highway towards Tiruppur' },
    { icon: '🚌', label: 'BY BUS', text: 'Inter-city buses from Tiruppur to Komarapalayam/Erode available regularly. Private bus services also available.' },
    { icon: '🚆', label: 'NEAREST RAILWAY STATION', text: 'Tiruppur Junction (~85 km from campus)' },
    { icon: '✈️', label: 'NEAREST AIRPORT', text: 'Coimbatore International Airport (Code: CJB) (~50 km)' },
  ...
  const facilities = [
    ...
    { icon: '🚌', title: 'Transport', desc: 'College buses connecting to Tiruppur and surrounding areas' },
