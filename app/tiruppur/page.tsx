...
export default function TiruppurPage() {
  ...
  const programmes = [
    ...
    { title: 'MDS (Master of Dental Surgery)', href: '/academics/mds/', duration: '3 years', level: 'PG', intake: '18 seats', eligibility: 'BDS degree; NEET MDS qualified' },
  ];
    ...
    <>
      ...
      >
        ...
        <p className="text-white/80 max-w-2xl mb-10 leading-relaxed" style={{ fontSize: 'clamp(0.9rem, 1vw + 0.5rem, 1.1rem)' }}>
          ...
          93.9% placed or in higher studies (2024-25 batch) — no need to go to Coimbatore — quality
