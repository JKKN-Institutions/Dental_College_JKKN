...
export default function HosurPage() {
  ...
  const transportRows = [
    ...
    { icon: <Train className="w-6 h-6 text-[#006837]" />, label: 'BY TRAIN', text: 'Trains on the Bengaluru–Salem line to Salem Junction — approximately 60 km from campus by road' },
  ...
  return (
    <>
      ...
      <div className="speakable-summary sr-only" id="speakable-intro">
        JKKN Dental College and Hospital is an established NDC-approved dental college for students from Hosur, Krishnagiri and Dharmapuri, located at Komarapalayam, Namakkal, reachable directly on NH-44 via Salem. The college offers BDS with one hundred seats and MDS with five specialisations, affiliated to TN Dr. MGR Medical University.
      </div>
