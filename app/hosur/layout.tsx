...
const howToSchema = {
  ...
  "step": [
    ...
    { "@type": "HowToStep", "position": 3, "name": "Continue on NH-544 towards Komarapalayam", "text": "From Salem, take NH-544 (Salem–Coimbatore Highway) for approximately 60 km to reach Komarapalayam." },
