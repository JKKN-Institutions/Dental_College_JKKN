...
export default function CoimbatorePage() {
  ...
  const faqs = [
    ...
    {
      q: 'How far is JKKN Dental from Coimbatore?',
      a: 'JKKN Dental is approximately 100-110 km from Coimbatore city centre, which takes about 2-2.5 hours by road via NH-544 (Coimbatore-Salem Highway) — direct route. Regular bus services are available from Coimbatore.',
    },
    {
    ...
    },
    {
      ...
      a: 'Yes, JKKN Dental provides separate hostel facilities for boys and girls. Students from Coimbatore can also opt for daily commute as the campus is just 2-2.5 hours away. College transport services are available.',
    },
    {
  ...
  const whyFeatures = [
    ...
    { icon: '🚌', title: 'Easy Commute', desc: 'Just 100-110 km from Coimbatore. Daily commute or comfortable hostel — your choice.' },
  ];
  ...
  const transportRows = [
    { icon: '🛣️', label: 'ROUTE', text: 'NH-544 (Coimbatore-Salem Highway) — direct route' },
    { icon: '🚌', label: 'BY BUS', text: 'Frequent inter-city buses from Gandhipuram and Ukkadam bus stands to Komarapalayam/Namakkal route' },
    { icon: '🚆', label: 'NEAREST RAILWAY STATION', text: 'Coimbatore Junction (~105 km from campus)' },
    { icon: '✈️', label: 'NEAREST AIRPORT', text: 'Coimbatore International Airport (Code: CJB) (~100 km)' },
  ...
  const facilities = [
    ...
    { icon: '🚌', title: 'Transport', desc: 'College buses connecting to Coimbatore and surrounding areas' },
  ...
  const cities = [
    { icon: '🏠', name: 'Namakkal', dist: '5-10 km' },
  ...
  return (
    <main className="overflow-x-hidden w-full">
      ...
      >
        ...
        <h1 className="text-white font-extrabold leading-tight mb-4 max-w-4xl" style={{ fontSize: 'clamp(2rem, 5vw + 0.5rem, 3.5rem)' }}>
          Best Dental College Near <span className="text-[#7cb983]">Coimbatore</span>
        </h1>
        <div className="flex justify-center mb-6">
          <LastUpdated date="2026-03-18" className="text-white/60" />
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <a href="https://wa.me/919345855001" target="_blank" rel="nofollow noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-full transition-all transform hover:scale-105 shadow-lg text-base">
            Apply Now — 2026-27
          </a>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center gap-6 justify-between">
            <div className="flex items-start gap-5">
              <div className="text-[#006837] font-extrabold leading-none" style={{ fontSize: 'clamp(3rem, 6vw, 4rem)' }}>
                105<span className="text-xl sm:text-2xl font-bold">km</span>
              </div>
              <div>
                <p className="font-bold text-gray-900 text-base sm:text-lg">From Coimbatore to JKKN Dental</p>
                <p className="text-gray-500 text-sm mt-1">2-2.5 hours via NH-544 (Coimbatore-Salem Highway) — direct route</p>
              </div>
            </div>
            <a
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="font-extrabold text-gray-900 mb-4" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            Why Coimbatore Students Choose JKKN Dental
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {programmes.map((prog) => (
              <div key={prog.title} className="bg-white rounded-2xl p-6 sm:p-8 text-left shadow-sm">
                ...
                <a href="https://wa.me/919345855001" target="_blank" rel="nofollow noopener noreferrer" className="block text-center bg-[#FBFBEE] hover:bg-[#e8f5e9] text-[#006837] font-semibold py-3 rounded-xl transition-colors text-sm">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-sm text-left">
            <div className="bg-[#006837] text-white px-6 py-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">100-110 km • 2-2.5 hours</p>
              </div>
            </div>
      ...
      {/* ── Footer ── */}
      <footer className="bg-[#002309] text-white pt-14 pb-6 px-4">
