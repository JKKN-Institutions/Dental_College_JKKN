...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'JKKN Dental College maintains a 92% placement rate (2024-25 batch) across all programs. Graduates are placed in leading hospitals, dental clinics, and healthcare organizations in India and internationally, including opportunities in the UK (NHS), UAE, and Saudi Arabia.',
      },
    },
  ],
};
