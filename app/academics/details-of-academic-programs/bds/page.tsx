...
export default function BDSProgram() {
  ...
  const bdsPageFaqs = [
              ...
              },
              {
                ...
                a: 'JKKN Dental College is at Natarajapuram, NH-544, Komarapalayam, Namakkal District, Tamil Nadu 638183. Distances: Erode (~18 km, 35 min), Salem (~60 km, 1 hr), Namakkal town (~65 km), Tiruppur (~67 km), Coimbatore (~105 km, 2 hrs). It is approved by the National Dental Commission and NAAC accredited with an A Grade.'
              },
              {
