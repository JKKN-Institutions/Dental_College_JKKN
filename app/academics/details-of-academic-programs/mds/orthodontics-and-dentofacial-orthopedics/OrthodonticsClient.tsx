          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-orthodontics-and-dentofacial-orthopedics-orthodonticsclient" target="_blank" rel="noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg inline-block">
                  Apply Now
                </a>
                <button
            ...
            <div className="relative">
              <div className="relative rounded-2xl border-4 border-white/20 overflow-hidden">
                <Image
                  ...
                  alt="MDS Orthodontics and Dentofacial Orthopedics digital lab with 3D imaging at JKKN Dental College"
                  width={600}
                  height={400}
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden aspect-square shadow-lg">
                <Image
                  ...
                  alt="MDS Orthodontics student fitting braces and aligners during clinical training at JKKN Dental Hospital"
                  fill
