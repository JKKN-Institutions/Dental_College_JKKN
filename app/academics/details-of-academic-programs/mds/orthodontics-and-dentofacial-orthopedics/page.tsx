...
export default function MDSOrthodontics() {
  ...
  const speakableSchema = generateSpeakableWebPageSchema({
    ...
    description: 'JKKN Dental College offers top orthodontic courses in India. NDC-approved MDS in Orthodontics & Dentofacial Orthopaedics with advanced clinical training.',
    url: 'https://dental.jkkn.ac.in/academics/details-of-academic-programs/mds/orthodontics-and-dentofacial-orthopedics/',
  ...
  return (
    <main className="overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-orthodontics-and-dentofacial-orthopedics" target="_blank" rel="noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg inline-block">
                  Apply Now
                </a>
                <button
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-[#FBFBEE] rounded-lg">
                  ...
                  <p className="text-gray-700 pt-1">
                    BDS degree from a NDC-recognized dental college
                  </p>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-[#FBFBEE] rounded-lg">
                  ...
                  <p className="text-gray-700 pt-1">
                    Valid registration with State Dental Council or NDC
                  </p>
                </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-[#FBFBEE] rounded-lg p-4 flex items-start gap-3">
                  ...
                  <span className="text-gray-700 text-sm">NDC/State Registration</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <div className="bg-gradient-to-br from-[#7cb983] to-[#6ba872] rounded-2xl aspect-square flex items-center justify-center p-3 md:p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-base md:text-2xl font-bold text-white text-center">Digital Learning Lab</h3>
            </div>
            ...
            {/* Wire Lab */}
            <div className="bg-gradient-to-br from-[#006837] to-[#002309] rounded-2xl aspect-square flex items-center justify-center p-3 md:p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-base md:text-2xl font-bold text-white text-center">Wire Learning Lab</h3>
            </div>
            ...
            {/* Research Lab */}
            <div className="bg-gradient-to-br from-[#006837] to-[#002309] rounded-2xl aspect-square flex items-center justify-center p-3 md:p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-base md:text-2xl font-bold text-white text-center">Research Learning Lab</h3>
            </div>

            {/* Library */}
            <div className="bg-gradient-to-br from-[#7cb983] to-[#6ba872] rounded-2xl aspect-square flex items-center justify-center p-3 md:p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-base md:text-2xl font-bold text-white text-center">Learning Commons</h3>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
            ...
            <div className="flex flex-col items-center">
              <div className="bg-[#006837] rounded-xl w-20 h-20 sm:w-24 sm:h-24 flex items-center justify-center mb-4 shadow-lg">
                <span className="text-2xl sm:text-3xl font-bold text-white">NDC</span>
              </div>
              <h3 className="text-center font-bold text-gray-900 text-sm sm:text-base">National Dental Commission (formerly Dental Council of India)</h3>
            </div>
      ...
      <section className="bg-[#7cb983] py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-orthodontics-and-dentofacial-orthopedics" target="_blank" rel="noopener noreferrer" className="bg-transparent border-2 border-white text-white hover:bg-[#FBFBEE] hover:text-[#7cb983] font-bold px-10 py-4 rounded-lg text-lg transition-all duration-300">
              Apply Online
            </a>
          </div>
        </div>
      ...
      <MdsSpecialityNav current="orthodontics-and-dentofacial-orthopedics" />
