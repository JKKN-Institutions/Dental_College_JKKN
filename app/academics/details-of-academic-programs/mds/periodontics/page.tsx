...
export default function MDSPeriodontics() {
  ...
  const speakableSchema = generateSpeakableWebPageSchema({
    ...
    description: 'MDS in Periodontics at JKKN Dental College. 3-year postgraduate program in gum disease treatment, dental implants, and periodontal surgery. NDC approved, expert faculty, modern facilities.',
  ...
  return (
    <main className="overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-periodontics" target="_blank" rel="noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg inline-block">
                  Apply Now
                </a>
                <button
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-gray-700">BDS degree from a NDC-recognized dental college</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-gray-700">Valid registration with State Dental Council or NDC</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-gray-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <span className="text-sm text-gray-700">NDC/State Registration</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-8 border-2 border-gray-200 hover:border-[#006837] transition-all duration-300 text-center">
              ...
              <h3 className="text-base sm:text-lg font-bold text-gray-900">National Dental Commission (formerly Dental Council of India)</h3>
            </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#7cb983] to-[#6ba872]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-periodontics" target="_blank" rel="noopener noreferrer" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#7cb983] font-bold px-10 py-4 rounded-lg text-lg transition-all duration-300">
              Apply Online
            </a>
          </div>
        </div>
      ...
      <MdsSpecialityNav current="periodontics" />
