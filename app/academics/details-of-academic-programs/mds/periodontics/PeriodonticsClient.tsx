          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-periodontics-periodonticsclient" target="_blank" rel="noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg inline-block">
                  Apply Now
                </a>
                <button
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#7cb983] to-[#6ba872]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-periodontics-periodonticsclient" target="_blank" rel="noopener noreferrer" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#7cb983] font-bold px-10 py-4 rounded-lg text-lg transition-all duration-300">
              Apply Online
            </a>
          </div>
        </div>
