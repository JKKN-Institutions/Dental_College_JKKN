  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Government scholarships available: SC/SCA/ST/BC-CC — PMSS (GQ: 2.5L/Yr, MQ: 6L/Yr), Maintenance Scholarship (GQ: 5K–10K/Yr); BC/MBC/DNC/BCM — First Graduate (40K/Yr), Community Scholarship (5K–10K/Yr); All Community Tamil Medium (Govt School 6–12 Std) — Naan Mudhalvan Scholarship (₹1,000/month). Merit-based scholarships and education loans from nationalized banks are also available."
        }
      },
      {
        "@type": "Question",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-conservative-dentistry-and-endodontics" target="_blank" rel="noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg inline-block">
                  Apply Now
                </a>
                <button
      ...
      <section id="curriculum" className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-4xl mx-auto leading-relaxed">
            A comprehensive learning framework designed to build expertise progressively from foundational knowledge to specialized clinical mastery.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="p-6">
                <h4 className="font-bold text-gray-800 text-xl mb-3">Simulation Learning Lab</h4>
                <p className="text-gray-600">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            {/* Library */}
            <div className="bg-gradient-to-br from-[#7cb983] to-[#6ba872] rounded-2xl p-6 md:p-12 flex items-center justify-center aspect-square hover:shadow-2xl transition-shadow duration-300 cursor-pointer">
              <h3 className="text-xl md:text-4xl font-bold text-white">Learning Commons</h3>
            </div>
            ...
            {/* Lab */}
            <div className="bg-gradient-to-br from-[#006837] to-[#002309] rounded-2xl p-6 md:p-12 flex items-center justify-center aspect-square hover:shadow-2xl transition-shadow duration-300 cursor-pointer">
              <h3 className="text-xl md:text-4xl font-bold text-white">Learning Lab</h3>
            </div>
          ...
          <div className="overflow-x-auto">
            <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden min-w-[640px]">
              ...
              <div className="divide-y divide-gray-200">
                ...
                <div className="grid grid-cols-4 hover:bg-gray-50 transition-colors duration-200">
                  <div className="p-4 md:p-6 border-r border-gray-200">
                    <p className="text-gray-700 font-medium text-sm md:text-base">Hostel Fee (Boys &amp; Girls, Per Annum)</p>
                  </div>
                  <div className="p-4 md:p-6 border-r border-gray-200">
                    <p className="text-gray-800 font-bold text-base md:text-lg">Contact office</p>
                  </div>
                  <div className="p-4 md:p-6 border-r border-gray-200">
                    <p className="text-gray-800 font-bold text-base md:text-lg">Contact office</p>
                  </div>
      ...
      <section className="bg-[#7cb983] py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-conservative-dentistry-and-endodontics" target="_blank" rel="noopener noreferrer" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#7cb983] font-bold px-10 py-4 rounded-lg text-lg transition-all duration-300">
              Apply Online
            </a>
          </div>
        </div>
