...
export const metadata: Metadata = {
  title: { absolute: 'MDS Colleges in Tamil Nadu — All 19 Affiliated Colleges, Seats & NIRF Top Ranks 2025-26 | JKKN' },
  description:
    'Every MDS college in Tamil Nadu (Tamilnadu) affiliated to the TN Dr M.G.R. Medical University — 19 colleges, 435 seats, location, government or self-financing, speciality-wise intake for 2025-26, plus the 9 Tamil Nadu institutions in the NIRF 2025 dental top 40.',
  keywords:
  ...
  openGraph: {
    title: 'MDS Colleges in Tamil Nadu — All 19 Affiliated Colleges, Seats & NIRF Top Ranks 2025-26',
    description:
