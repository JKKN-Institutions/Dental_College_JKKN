...
export default function MDSOralMedicine() {
  ...
  return (
    <main className="overflow-x-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-oral-medicine" target="_blank" rel="noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg inline-block">
                  Apply Now
                </a>
                <button
          ...
          <div className="mt-8 bg-blue-50 border-l-4 border-blue-400 p-6 rounded-r-lg">
            <div className="flex gap-4">
              ...
              <p className="text-gray-700">
                Fee structure is subject to revision as per university and government norms. Hostel fees: contact the admissions office (charged separately for both boys and girls). Classic Mess and Premium Mess are not available for Dental students. Government scholarships (PMSS, Naan Mudhalvan, First Graduate, etc.), merit-based scholarships, and education loan assistance are available for eligible Learners.
              </p>
            </div>
          </div>
        </div>
      ...
      <MdsSpecialityNav current="oral-medicine" />
