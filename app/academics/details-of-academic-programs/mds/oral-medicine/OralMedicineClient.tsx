          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-oral-medicine-oralmedicineclient" target="_blank" rel="noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg inline-block">
                  Apply Now
                </a>
                <button
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#006837] to-[#002309] rounded-2xl border-4 border-white/20 overflow-hidden relative min-h-[400px] md:min-h-[450px]">
                <Image
                  ...
                  alt="MDS Oral Medicine and Radiology department with CBCT imaging equipment at JKKN Dental College"
                  fill
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#7cb983] to-[#6ba872] rounded-3xl overflow-hidden h-full min-h-[400px]">
                <Image
                  ...
                  alt="Oral medicine diagnostic center with digital radiography at JKKN Dental Hospital, Komarapalayam"
                  fill
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#7cb983] to-[#6ba872]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=academics-details-of-academic-programs-mds-oral-medicine-oralmedicineclient" target="_blank" rel="noopener noreferrer" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#7cb983] font-bold px-10 py-4 rounded-lg text-lg transition-all duration-300">
              Apply Online
            </a>
          </div>
        </div>
