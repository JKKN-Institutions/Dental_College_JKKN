...
export default function SalemPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'At JKKN Dental College & Hospital, BDS tuition fees are approximately ₹2,50,000 under Government Quota. Management quota fees are available separately. Contact +91 9345855001 or visit admission.jkkn.ac.in for the latest fee structure and 2026 admission details.',
    },
    {
    ...
    <main className="overflow-x-hidden w-full">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <a href="https://admission.jkkn.ac.in/" target="_blank" rel="nofollow noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-full transition-all transform hover:scale-105 shadow-lg text-base">
            Apply for BDS 2026 →
          </a>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-sm mt-6 mb-2">
            Learn more about the <Link href="/academics/bds/" className="text-[#006837] hover:underline font-medium">BDS programme at JKKN Dental College</Link> or explore all <Link href="/academics/mds/" className="text-[#006837] hover:underline font-medium">MDS specializations at JKKN Dental College</Link>.
          </p>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#006837] text-white rounded-xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <a href="https://admission.jkkn.ac.in/" target="_blank" rel="noopener noreferrer" className="flex-shrink-0 bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-6 py-3 rounded-full transition-colors text-sm">
              Apply for BDS 2026 →
            </a>
          </div>
        </div>
