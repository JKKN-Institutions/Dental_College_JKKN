...
export default function SalemPage() {
  ...
  const whyFeatures = [
    ...
    { icon: '🚌', title: 'Easy Commute', desc: 'Just 40-50 km from Salem. Daily commute or comfortable hostel — your choice.' },
  ];
  ...
  const transportRows = [
    { icon: '🛣️', label: 'ROUTE', text: 'NH-544 (Salem-Coimbatore Highway) — direct route' },
    { icon: '🚌', label: 'BY BUS', text: 'TN State Transport buses from Salem New Bus Stand to Komarapalayam run every 15-20 minutes throughout the day' },
    { icon: '🚆', label: 'NEAREST RAILWAY STATION', text: 'Salem Junction (~45 km from campus)' },
    { icon: '✈️', label: 'NEAREST AIRPORT', text: 'Salem Airport (limited flights) / Coimbatore International Airport (~15 km / ~110 km)' },
  ...
  const facilities = [
    ...
    { icon: '🚌', title: 'Transport', desc: 'College buses connecting to Salem and surrounding areas' },
