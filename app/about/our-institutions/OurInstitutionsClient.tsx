...
export default function OurInstitutionsClient() {
  return (
    <main>
      <Header />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="w-full h-[300px] md:h-[350px] overflow-hidden">
            <Image
              ...
              alt="JKKN Institutions campus aerial view showing academic blocks and facilities, Komarapalayam, Tamil Nadu"
              width={1400}
              height={350}
