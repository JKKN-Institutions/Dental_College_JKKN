  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-white/60 text-sm font-medium tracking-wide mb-6">Established NDC-Approved Dental College — JKKN Dental College &amp; Hospital, Komarapalayam</p>
      ...
      <div className="speakable-summary sr-only" id="speakable-intro">
        JKKN Dental College and Hospital is an established NDC-approved dental college accessible from Madurai, located approximately two hundred and fifteen kilometres away at Komarapalayam, Namakkal. The college offers BDS with one hundred seats and MDS with five specialisations, affiliated to TN Dr. MGR Medical University.
      </div>
