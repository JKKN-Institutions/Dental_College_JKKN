...
export default function MaduraiPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'JKKN Dental College & Hospital at Komarapalayam is one of the most established DCI-approved dental colleges accessible from Madurai. Founded in 1987, NAAC accredited and affiliated to The Tamil Nadu Dr. M.G.R. Medical University, it operates a 200+ chair teaching hospital treating 500+ patients daily.',
    },
    {
  ...
  const whyFeatures = [
    ...
    { icon: <TrendingUp className="w-6 h-6 text-[#006837]" />, title: 'MDS in 5 Specialisations', desc: 'Full postgraduate pathway — rare among colleges accessible from Madurai' },
    ...
    { icon: <Home className="w-6 h-6 text-[#006837]" />, title: 'Residential Campus', desc: 'Separate boys and girls hostels — comfortable stay for learners from Madurai' },
  ];
  ...
  const transportRows = [
    { icon: <Route className="w-6 h-6 text-[#006837]" />, label: 'ROUTE', text: 'NH-44 from Madurai through Dindigul to Karur (~140 km), then via the Erode side to Komarapalayam (~75 km) — approximately 215 km total' },
    { icon: <Bus className="w-6 h-6 text-[#006837]" />, label: 'BY BUS', text: 'Frequent government buses from Madurai (Mattuthavani) towards Erode and Salem; connect at Erode or get down at Komarapalayam on the Salem route' },
    { icon: <Train className="w-6 h-6 text-[#006837]" />, label: 'BY TRAIN', text: 'Trains from Madurai Junction towards Erode Junction — Erode Junction is ~18 km from campus' },
    { icon: <Plane className="w-6 h-6 text-[#006837]" />, label: 'NEAREST AIRPORT', text: 'Coimbatore International Airport (Code: CJB) (~108 km from campus); Madurai Airport (IXM) serves the Madurai side' },
  ...
  const cities = [
    { icon: <Home className="w-6 h-6 text-[#006837]" />, name: 'Trichy', dist: '~145 km', href: '/trichy/' },
    ...
    <>
      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-gray-100">
        <div className="max-w-5xl mx-auto px-4 py-3">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li className="text-gray-900 font-medium">Dental College near Madurai</li>
          </ol>
        </div>
      </nav>
      ...
      >
        ...
        <h1 className="text-white font-extrabold leading-tight mb-3 max-w-4xl" style={{ fontSize: 'clamp(2rem, 5vw + 0.5rem, 3.5rem)' }}>
          Dental College near <span className="text-[#7cb983]">Madurai</span>
        </h1>
        ...
        <p className="text-white/80 max-w-2xl mb-10 leading-relaxed" style={{ fontSize: 'clamp(0.9rem, 1vw + 0.5rem, 1.1rem)' }}>
          Madurai has only a couple of dental colleges — seats fill fast. JKKN Dental College &amp; Hospital at Komarapalayam offers
          BDS with 100 seats and MDS in 5 specialisations, with a 200+ chair teaching hospital and 93.9% placed or in higher studies (2024-25 batch).
        </p>
        <ul className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-10 w-full max-w-2xl list-none p-0 m-0">
          {[
            { value: '93.9%', label: 'PLACED OR IN HIGHER STUDIES 2024-25' },
            { value: 'Rs 3.6L', label: 'BDS MEDIAN SALARY' },
            { value: '~215km', label: 'FROM MADURAI' },
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=madurai" target="_blank" rel="nofollow noopener noreferrer" className="bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-full transition-all transform hover:scale-105 shadow-lg text-base">
            Apply Now — 2026-27
          </a>
      ...
      <div className="speakable-summary sr-only" id="speakable-intro">
        JKKN Dental College and Hospital is an established DCI-approved dental college accessible from Madurai, located approximately two hundred and fifteen kilometres away at Komarapalayam, Namakkal. The college offers BDS with one hundred seats and MDS with five specialisations, affiliated to TN Dr. MGR Medical University.
      </div>

      {/* ── Snippet Answer Section (AEO Target) ── */}
      <section className="bg-white py-12 px-4" id="dental-colleges-madurai">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-extrabold text-gray-900 mb-4" style={{ fontSize: 'clamp(1.4rem, 2.5vw + 0.5rem, 2rem)' }}>
            How Many Dental Colleges Are in Madurai?
          </h2>
          <div className="snippet-answer voice-answer">
            <p className="text-gray-700 leading-relaxed mb-4" style={{ fontSize: 'clamp(0.95rem, 1vw + 0.4rem, 1.1rem)' }}>
              Madurai has only a couple of dental colleges, so BDS seats in the city fill quickly and many aspirants from Madurai district look towards western Tamil Nadu. <strong>JKKN Dental College &amp; Hospital</strong> at Komarapalayam, Namakkal — approximately 215 km via NH-44 through Dindigul and Karur — is one of the region&apos;s most established choices. Founded in 1987 and affiliated to TN Dr. MGR Medical University, Chennai, it offers BDS with 100 government-sanctioned seats and MDS in 5 specialisations, and operates a 200-chair teaching hospital treating 500+ patients daily.
            </p>
          </div>
          <h3 className="font-bold text-gray-900 mb-3 text-lg">Why Madurai Students Look Towards Namakkal District</h3>
          <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4" style={{ fontSize: 'clamp(0.9rem, 1vw + 0.4rem, 1.05rem)' }}>
            <li>More seat availability — 100 BDS seats plus a full MDS pathway in 5 specialisations</li>
            <li>Direct rail connectivity — Madurai Junction to Erode Junction, 18 km from campus</li>
            <li>Full residential campus — separate hostels, mess, and holiday travel home is easy</li>
          </ul>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center gap-6 justify-between">
            <div className="flex items-start gap-5">
              <div className="text-[#006837] font-extrabold leading-none" style={{ fontSize: 'clamp(3rem, 6vw, 4rem)' }}>
                215<span className="text-xl sm:text-2xl font-bold">km</span>
              </div>
              <div>
                <p className="font-bold text-gray-900 text-base sm:text-lg">From Madurai to JKKN Dental</p>
                <p className="text-gray-500 text-sm mt-1">4–4.5 hours via NH-44 through Dindigul and Karur</p>
              </div>
            </div>
            <a
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="font-extrabold text-gray-900 mb-4" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            Why Madurai Learners Choose JKKN Dental
          </h2>
          <p className="text-gray-500 max-w-3xl mx-auto mb-2 leading-relaxed" style={{ fontSize: 'clamp(0.875rem, 1vw + 0.4rem, 1.05rem)' }}>
            Madurai is south Tamil Nadu&apos;s education capital, but its dental seats are few. JKKN Dental at Komarapalayam offers Madurai learners an established teaching hospital, a full MDS pathway, and hostel life on a residential campus — with direct trains connecting Madurai Junction to Erode Junction.
          </p>
      ...
      <section className="bg-[#FBFBEE] py-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="font-extrabold text-gray-900 mb-3" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            BDS and MDS Programs at JKKN Dental College Near Madurai
          </h2>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-extrabold text-gray-900 mb-3 text-center" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            BDS Admission 2026 — How to Apply from Madurai
          </h2>
          <p className="text-gray-500 text-base mb-4 text-center">Step-by-step admission process for Madurai learners</p>
          ...
          <ol className="space-y-4 list-none p-0 m-0">
            {[
              ...
              { step: 'Step 5', title: 'Confirm Admission', desc: 'Pay the first year fee and confirm your seat. Hostel registration available separately for learners from Madurai.' },
            ].map((item) => (
          ...
          <div className="mt-8 text-center">
            <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=dental.jkkn.ac.in&utm_medium=organic&utm_campaign=madurai" target="_blank" rel="nofollow noopener noreferrer" className="inline-block bg-[#7cb983] hover:bg-[#6ba872] text-white font-bold px-8 py-4 rounded-full transition-all transform hover:scale-105 shadow-lg text-sm">
      ...
      <section className="bg-[#FBFBEE] py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-extrabold text-gray-900 mb-3" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            How Far Is JKKN Dental College from Madurai?
          </h2>
          <p className="snippet-answer text-gray-700 text-base mb-4">JKKN Dental College &amp; Hospital is approximately 215 km from Madurai via NH-44 through Dindigul and Karur — a journey of approximately 4 to 4.5 hours by road. Trains from Madurai Junction towards Erode Junction bring you within 18 km of the campus.</p>
          <div className="w-14 h-1 bg-[#7cb983] rounded mx-auto mb-10" />
          <div className="bg-white rounded-2xl overflow-hidden shadow-sm text-left">
            <div className="bg-[#006837] text-white px-6 py-5 flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-lg">Madurai → JKKN Dental Campus</p>
                <p className="text-white/80 text-sm">~215 km • 4–4.5 hours via NH-44 + Karur</p>
              </div>
            </div>
      ...
      <section className="bg-white py-16 px-4" id="about-jkkn-madurai">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-extrabold text-gray-900 mb-3 text-center" style={{ fontSize: 'clamp(1.6rem, 3vw + 0.5rem, 2.4rem)' }}>
            JKKN Dental College &amp; Hospital — Key Facts
          </h2>
          <p className="text-gray-500 text-base mb-4 text-center">Essential information for Madurai learners considering dental education</p>
          <div className="w-14 h-1 bg-[#7cb983] rounded mx-auto mb-10" />
          <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { label: 'Location', value: 'Natarajapuram, NH-544, Komarapalayam, Namakkal, Tamil Nadu 638183' },
              { label: 'Distance from Madurai', value: 'Approximately 215 km via NH-44 — 4–4.5 hours by road' },
      ...
      <section className="bg-[#FBFBEE] py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-base mb-4">Common questions about dental education options for Madurai learners</p>
          <div className="w-14 h-1 bg-[#7cb983] rounded mx-auto mb-12" />
