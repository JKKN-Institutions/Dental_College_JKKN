...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'BDS from a National Dental Commission (NDC), formerly the Dental Council of India recognised institution + completed 1-year compulsory rotational internship before 31st March of the admission year + permanent State Dental Council registration + valid NEET-MDS 2026 score.',
  },
  {
    question: 'How many MDS Conservative Dentistry seats are at JKKN Dental College?',
    answer:
      'JKKN Dental College & Hospital is approved by NDC for 3 MDS seats per year in Conservative Dentistry and Endodontics. Admission is through Tamil Nadu state PG dental counselling based on NEET-MDS All-India ranks, across Government, Management and NRI Quotas.',
  },
  {
