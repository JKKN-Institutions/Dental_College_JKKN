...
import { Clock, Activity, ChevronUp, Mail, TrendingUp, AlignLeft } from 'lucide-react';

const tocItems = [
  { id: 'what-is-perio', label: 'What is MDS Periodontics?' },
  ...
  { id: 'why-jkkn', label: 'Why JKKN for Periodontics' },
  { id: 'faq', label: 'Frequently Asked Questions' },
];

const popularPosts = [
  { category: 'MDS', title: 'MDS Prosthodontics 2026: Eligibility, Fees & Career Guide', date: 'May 16, 2026' },
  { category: 'MDS', title: 'MDS Orthodontics 2026: Complete Guide & Career Scope', date: 'May 16, 2026' },
  { category: 'Career', title: 'Dental Implants & Career Outlook for Periodontists in India', date: 'Apr 24, 2026' },
];

const FIXED_TOP = 104;
interface FAQ { question: string; answer: string; }

export default function MdsPeriodonticsClient({ faqs }: { faqs: FAQ[] }) {
  const [activeSection, setActiveSection] = useState('what-is-perio');
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-6">
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight mb-6">
          MDS Periodontics 2026: Eligibility, Fees &amp; Career Guide
        </h1>
        <p className="hero-description text-lg text-gray-600 leading-relaxed mb-6 max-w-4xl">
          Complete guide to MDS Periodontics — for BDS graduates planning a surgical dental
          specialisation with strong implant practice scope. Eligibility, NEET-MDS cutoff, 3-year
          syllabus, fees, career &amp; salary outlook, and JKKN-specific opportunities.
        </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10">
        <div className="w-full rounded-2xl bg-gradient-to-br from-[#6ba872] to-[#002309] flex flex-col items-center justify-center py-16 sm:py-20 gap-3">
          ...
          <p className="text-white font-semibold text-lg">MDS Periodontics</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-10 relative" ref={gridRef}>
          <main className="min-w-0">
            ...
            <section id="what-is-perio" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">What is MDS Periodontics?</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
                <strong>Periodontics</strong> is the dental specialisation dealing with the
                periodontium — the supporting structures around teeth: gums (gingiva), periodontal
                ligament, cementum and alveolar bone. Periodontists diagnose, prevent and treat
                periodontal (gum) diseases including gingivitis, periodontitis, aggressive
                periodontitis, and peri-implantitis around dental implants.
              </p>
              <p className="text-gray-600 leading-relaxed mb-4">
                Modern periodontal practice is significantly surgical: <strong>flap surgery</strong>,
                guided tissue regeneration (GTR), bone grafting, sinus lifts, ridge augmentation,
                gingival depigmentation, crown lengthening, frenectomy, and <strong>dental implant
                placement</strong>. Periodontists also manage soft-tissue aesthetics — gummy smile
                correction, gingival contouring and gum-line zenith management for aesthetic
                rehabilitation.
              </p>
              <p className="text-gray-600 leading-relaxed">
                The implant explosion in India (projected double-digit annual growth through 2030),
                rising periodontal disease prevalence, and demand for aesthetic gum procedures make
                periodontics one of the <strong>fastest-growing high-revenue dental
                specialisations</strong>.
              </p>
            </section>
            ...
            <section id="eligibility" className="mb-12 scroll-mt-20">
              ...
              <div className="bg-amber-50 border-l-4 border-amber-400 rounded-r-xl p-4">
                <p className="text-sm text-gray-700">
                  <strong className="text-amber-700">Note:</strong> Periodontics is one of the
                  in-demand MDS branches at private TN dental colleges. Government Quota closing
                  ranks typically fall in top 8,000–12,000 NEET-MDS All-India ranks. Always refer
                  to <em>tnmedicalselection.net</em> for current-year cutoffs.
                </p>
              </div>
            </section>
            ...
            <section id="duration-structure" className="mb-12 scroll-mt-20">
              ...
              <ul className="space-y-2.5 mb-5">
                {[
                  ['Year 1 — Pre-clinical & foundational:', 'periodontal anatomy, microbiology of periodontal diseases, host response, applied immunology, basic perio surgery training'],
                  ['Year 2 — Clinical practice & dissertation:', 'flap surgery, GTR, bone grafting, implant placement training, library + clinical dissertation start'],
                  ['Year 3 — Advanced surgical & exit exam:', 'sinus lifts, ridge augmentation, peri-implantitis management, laser perio, dissertation submission and MDS final exam'],
                ].map(([k, v]) => (
            ...
            <section id="syllabus" className="mb-12 scroll-mt-20">
              ...
              <div className="overflow-x-auto mb-5">
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody>
                    {[
                      ['Paper I', 'Applied basic sciences: anatomy, oral microbiology, immunology, host response, biostatistics, research methodology'],
                      ['Paper II', 'Aetiology & pathogenesis of periodontal diseases, classification, diagnosis, epidemiology, periodontal medicine systemic links'],
                      ['Paper III', 'Periodontal therapy: non-surgical, surgical (flap, GTR, bone grafting), regenerative therapy, mucogingival surgery'],
                      ['Paper IV (Essay)', 'Recent advances: implant dentistry, laser periodontics, peri-implantitis, PRF/PRP, stem cell therapy, AI in perio diagnosis'],
                      ['Practical & Clinical', 'Periodontal charting, surgical case presentation, implant surgery, dissertation defence, viva'],
                    ].map(([p, t], i) => (
                      <tr key={i} className="border-b border-gray-100 last:border-0">
            ...
            <section id="career" className="mb-12 scroll-mt-20">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Career &amp; Salary After MDS Periodontics 2026</h2>
              <ul className="space-y-2.5 mb-5">
                {[
                  ['Periodontal & Implant Specialist:', 'standalone or partner practice — implant surgery is the largest revenue driver'],
                  ['Implant Surgeon at Corporate Chains:', 'Clove, Apollo White, FMS, Sabka Dentist — implant + perio consultant roles'],
                  ['Laser Periodontics Practice:', 'aesthetic gum procedures, depigmentation, frenectomy, gum recontouring'],
                  ['Regenerative Therapy Specialist:', 'GTR, PRF/PRP, bone grafting, advanced surgical techniques'],
                  ['Dental College Faculty:', 'Senior Lecturer → Reader → Professor career progression'],
                  ['Public Sector:', 'TNPSC Dental Surgeon (Specialist), defence, ESI, Railways'],
                  ['Dental Industry:', 'implant company consultants (Nobel Biocare, Straumann, Adin, Osstem), laser companies, regenerative materials'],
                  ['Overseas Practice:', 'after credential exams — Middle East (DHA/MOH), UK (ORE), Australia (ADC)'],
                ].map(([k, v]) => (
                  <li key={k as string} className="flex items-start gap-2.5 text-gray-600 text-sm">
                    <span className="w-2 h-2 rounded-full bg-[#006837] mt-1.5 flex-shrink-0" />
                    <span><strong>{k}</strong> {v}</span>
              ...
              <div className="overflow-x-auto mb-5">
                <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  <tbody>
                    {[
                      ['Consultant Periodontist', '₹70,000 – ₹1.3L / month', '₹2.5L – ₹5L+ / month'],
                      ['Implant-focused Practice', '₹1L – ₹1.5L / month', '₹3L – ₹8L+ / month'],
                      ['Own Specialty Practice', 'Variable', '₹3L – ₹8L+ / month'],
            ...
            <section id="why-jkkn" className="mb-12 scroll-mt-20">
              ...
              <ul className="space-y-2.5 mb-6">
                {[
                  ...
                  ['Research support:', 'institutional ethics committee, dissertation mentorship, publication assistance'],
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-10 border-b border-gray-100">
              <div className="flex flex-wrap items-center gap-2">
                ...
                {['MDS', 'Periodontics', 'NEET-MDS', 'Implant Dentistry', 'JKKN Dental'].map((tag) => (
