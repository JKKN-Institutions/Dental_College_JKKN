        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-xl p-8 shadow-sm border border-green-100 border-l-4 border-l-[#7cb983] mb-10">
            <p className="hero-description text-gray-700 text-base leading-relaxed text-justify">
              The Disciplinary Committee is a crucial body within educational institutions tasked with maintaining discipline and enforcing codes of conduct among learners and team members. Comprising senior learner members, administrators, and sometimes learner representatives, the committee handles disciplinary issues and violations of institutional rules. It conducts impartial investigations, provides fair hearings to individuals involved, and imposes appropriate disciplinary actions when necessary. The committee aims to create a safe and respectful learning environment, instilling a sense of responsibility and accountability among the learner community. By upholding disciplinary standards and promoting ethical behavior, the committee fosters a conducive atmosphere for academic growth, character development, and overall well-being within the institution.
            </p>
          </div>
