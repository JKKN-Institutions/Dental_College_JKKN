    ...
    <main>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl p-7 shadow-sm border border-green-100">
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              To be a leading global provider of innovative solutions that equip learners with skills, knowledge, and exposure for meaningful careers. We envision a future where individuals embrace continuous learning and adapt to society&apos;s evolving needs. Our goal is to empower learners to contribute their best to the nation and the world.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl p-7 shadow-sm border border-green-100">
            ...
            <div className="space-y-3 text-sm text-gray-700">
              ...
              <p className="leading-relaxed">Cultivate Top Professionals – Equip learners with essential skills and industry expertise to excel in their respective fields.</p>
              <p className="leading-relaxed">Empower Future Leaders – Provide mentorship and career development programs to help learners seize opportunities and become dynamic leaders.</p>
              <p className="leading-relaxed">Drive Meaningful Change – Enable learners to contribute to society&apos;s progress and global advancements through innovation and leadership.</p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              <h3 className="text-base font-bold text-[#002309] mb-4">Dear Learners, Senior Learners, and Industry Partners,</h3>
              <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
                <p>At JKKN Institutions, we believe education extends beyond learning studios—it&apos;s about equipping learners with skills, mindset, and opportunities for real-world success. The Career Development Center (CDC) bridges academic learning with industry needs, fostering career empowerment, entrepreneurship, and leadership.</p>
                <p>By integrating AI-driven learning, automation, and smart technologies, we aim to transform learners into future-ready professionals. AI is not a replacement for human potential but a catalyst for growth, creativity, and innovation. Let&apos;s embrace technology and talent to create endless possibilities.</p>
      ...
      <section className="bg-[#FBFBEE] py-14 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              <h3 className="text-base font-bold text-[#002309] mb-4">Dear Learners and Recruiters,</h3>
              <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
                <p>At JKKN EDUCATIONAL INSTITUTIONS we believe that the essence of education lies in preparing our learners not just for learning assessments, but for the real-world challenges that lie ahead. The Career Development Center (CDC), led by a dedicated team, is committed to honing the skills of our learners and matching them with the right opportunities to embark on successful careers.</p>
                <p>As the Head of CDC, I take immense pride in nurturing a generation that is not only industry-ready but equipped with a holistic development model, ensuring they thrive in any professional environment. Our placement process is designed to match the needs of the industry with the skills and aspirations of our learners, ensuring mutual growth and success.</p>
                <p>Warm regards,</p>
              </div>
              <div className="mt-6 pt-6 border-t border-green-100">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-700 text-sm mb-6 leading-relaxed">
              Our in house training programs are designed to develop the essential skills learners need to succeed in the <span className="font-bold">modern job market:</span>
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                { num: '1', title: 'Aptitude Training', body: 'Focused on improving problem-solving, numerical reasoning, and analytical skills, this program helps learners excel in aptitude tests, which are a crucial part of the recruitment process.' },
                { num: '2', title: 'Soft Skills Training', body: 'Emphasizing communication, teamwork, leadership, and time management, this program ensures that learners not only meet but exceed the expectations of prospective employers.' },
                { num: '3', title: 'TNPSC Academy', body: 'A specialized academy dedicated to preparing learners to crack state government exams, particularly TNPSC (Tamil Nadu Public Service Commission) exams, equipping them with the necessary strategies and knowledge.' },
                { num: '4', title: 'Golden Hour Training', body: "Golden Hour Training is an intensive, last-minute, company-specific training program designed to maximize a candidate's success in securing a job. This strategic training equips learners with the precise skills, insights, and confidence required to excel in final-stage interviews and assessments. By focusing on real-time industry expectations, employer-specific requirements, and proven success strategies, Golden Hour Training ensures candidates are fully prepared to make a lasting impression and win their desired job opportunities." },
              ].map(({ num, title, body }) => (
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-700 text-sm mb-6 leading-relaxed">
              In collaboration with leading training foundations, we outsource specialized training programs to ensure our learners get the best industry exposure:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {[
                ...
                { num: '2', title: 'Unnati Foundation', body: 'Offers skill development programs, helping learners bridge the gap between education and employment through comprehensive training modules.' },
                { num: '3', title: 'Bhumi Foundation', body: 'Engages learners with skill development and leadership training, helping them to become socially responsible individuals with a focus on community development.' },
              ].map(({ num, title, body }) => (
                <div key={num} className="bg-[#FBFBEE] rounded-xl p-6 border border-green-100">
                  <div className="flex items-center gap-3 mb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="bg-[#FBFBEE] rounded-xl p-6 border border-green-100">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h4 className="font-bold text-[#002309] text-sm">Personalized Learner Assessment</h4>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed">Each learner undergoes a holistic assessment through interactive sessions and feedback collection via the FACE SHEET form. This ensures a deep understanding of their individual career aspirations, allowing us to tailor their placement journey.</p>
              </div>
              ...
              <div className="bg-[#FBFBEE] rounded-xl p-6 border border-green-100">
                ...
                <div className="text-gray-600 text-sm leading-relaxed space-y-1">
                  ...
                  <p>Mock Interviews &amp; Group Discussions: Conducted by industry experts to prepare learners thoroughly.</p>
                </div>
              </div>
              ...
              <div className="bg-[#FBFBEE] rounded-xl p-6 border border-green-100">
                ...
                <div className="text-gray-600 text-sm leading-relaxed space-y-1">
                  ...
                  <p>Learner Placement Statistics</p>
              ...
              <div className="bg-[#FBFBEE] rounded-xl p-6 border border-green-100">
                ...
                <div className="text-gray-600 text-sm leading-relaxed space-y-1">
                  ...
                  <p>Learner Internship Success Stories</p>
                </div>
              </div>
      ...
      <section className="bg-[#FBFBEE] py-14 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <h4 className="text-base font-bold text-[#002309] mb-6 ml-5">Learner Clubs</h4>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-7 shadow-sm border border-green-100">
              <h4 className="font-bold text-[#006837] text-base mb-3">SMART Y Leaders Club</h4>
              <p className="text-gray-700 text-sm leading-relaxed">
                A platform that fosters leadership skills and encourages innovation among learners. Members work on real-world projects that develop managerial and entrepreneurial capabilities
              </p>
            </div>
            <div className="bg-white rounded-xl p-7 shadow-sm border border-green-100">
              <h4 className="font-bold text-[#006837] text-base mb-3">Gen Z Club</h4>
              <p className="text-gray-700 text-sm leading-relaxed">
                This club offers MBA learners a chance to explore various career paths, enhance their skills, and prepare for future opportunities through workshops, seminars, and expert talks
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-14 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="bg-[#FBFBEE] rounded-xl p-7 border-l-4 border-[#7cb983] mb-10">
            <h3 className="text-lg font-bold text-[#002309] mb-3">Learner Participation and Credits</h3>
            <p className="text-gray-700 text-sm leading-relaxed">
              All placement events, activities, and clubs are organized by the Career Development Center (CDC) Learner Coordinators, with the efforts being formally creditized as part of their professional development.
            </p>
          </div>
