...
export const metadata: Metadata = {
  alternates: { canonical: '/academic-calendar-2022-2023/' },
  ...
  openGraph: {
    title: 'Academic Calendar 2022-23 | JKKN Dental College Schedule',
    description: 'View JKKN Dental College academic calendar 2022-23. Check past exam dates, holidays and academic events. Access archived academic schedule PDF.',
    url: 'https://dental.jkkn.ac.in/academic-calendar-2022-2023/',
    type: 'website',
  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'Academic Calendar 2022-2023', url: 'https://dental.jkkn.ac.in/academic-calendar-2022-2023/' },
      ]} />
