    ...
    <section className="institution-highlights py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 bg-[#006837] text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-14">
          ...
          <p className="text-gray-300 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">JKKN Dental College stands out with 39+ years of excellence, 500+ daily patients for clinical exposure, AI-integrated campus technology, and 93.9% placed or in higher studies (2024-25 batch) backed by JKKN Institutions since 1952.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-10 sm:mb-12 md:mb-14">
          ...
          <ol className="space-y-5 sm:space-y-6 list-none p-0 m-0">
            ...
            <li className="flex gap-3 sm:gap-4">
              ...
              <div>
                <h4 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">93.9% Placed or in Higher Studies (2024-25)</h4>
                <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
